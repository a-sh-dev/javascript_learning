...
// * From CodeCademy: 
// Create a while loop with a condition that checks if the currentCard does not have 'spade'. Use random to generate random index to pick the card from cards until it finds spade
